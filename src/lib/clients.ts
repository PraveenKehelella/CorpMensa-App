  ...
  return [
    {
      ...
      vitalSignsHistory: [
        { date: daysAgo(2), heartRate: 72, systolic: 119, diastolic: 78 },
      ],
    ...
    },
    {
      ...
      vitalSignsHistory: [
        { date: daysAgo(5), heartRate: 78, systolic: 130, diastolic: 74 },
      ],
      cognitiveMetrics: null,
      cognitiveHistory: [],
    },
    {
      ...
      vitalSignsHistory: [
        { date: daysAgo(1), heartRate: 58, systolic: 116, diastolic: 73 },
      ],
      cognitiveMetrics: null,
      cognitiveHistory: [],
    },
    {
      ...
      vitalSignsHistory: [
        { date: daysAgo(3), heartRate: 65, systolic: 128, diastolic: 76 },
      ],
      cognitiveMetrics: null,
      cognitiveHistory: [],
    },
    {
      ...
      vitalSignsHistory: [
        { date: daysAgo(0), heartRate: 62, systolic: 132, diastolic: 80 },
      ],
      cognitiveMetrics: null,
      cognitiveHistory: [],
    },
